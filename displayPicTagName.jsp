...
<h2>All Pictures With Tag Name "<%=tagName%>" </h2>
<table>
<%
...
%>
		<tr>
       		<td>
            	<a href="/photoshare/displayPicture.jsp?picture_id=<%=pictureId%>">
...
%>
		<h4>Display <a href="displayMyPicTagName.jsp?tag_Id=<%=tid%>">
        	Only My Pictures</a> with Tag Name <%=tagName%> </h4>
<%
	}
%>
